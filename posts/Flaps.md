...
<b>Update 16th Jan 2026:</b> Flaps is now available as a library for developers to use in their own plugins! The docs are available [here](https://github.com/seailz/Flaps/wiki) along with an example plugin achieving the original roll effect I set out to create. Check it out!
<video controls>
